...
$APPLICATION->SetPageProperty("keywords", " лючевые слова");
$APPLICATION->SetPageProperty("description", "ќписание");
$APPLICATION->SetTitle("√лавна€ страница");
?>
    	<div class="span8">
        ...
        <div class="span4">
			...
			<p class="p1">Praesent vestibulum molestie lacus. Aenean nonummy hendrerit mauris. Phasellus porta. Fusce suscipit varius mi, nascetur ridiculus mus. Nulla dui. Fusce feugiat malesuada.Ф</p>
