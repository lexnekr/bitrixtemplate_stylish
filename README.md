...
* [13 Урок](http://кофедизайн.рф/information/integration_adaptive_bootstrap_site_template_in_1c_bitrix_step_lesson_13/) - Список Логотипов Клиентов и 4-х колоночный список элементов ИБ
...
-------
* Компонент bitrix:news.line - шаблон clients_logos_list (Список логотипов)
...
* Компонент bitrix:news.list - шаблон 4_columns (4х колоночный список элементов инфоблока)
